      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-10">
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-8">
          ...
          <div className="col-span-2 lg:col-span-2">
            ...
            <div className="space-y-2 text-xs mb-5">
              ...
              <a href="mailto:support@flyttgo.us" className="flex items-center gap-2 text-gray-400 hover:text-emerald-400 transition">
        ...
        <div className="border-t border-gray-800 mt-10 pt-8 grid sm:grid-cols-2 lg:grid-cols-4 gap-6 text-xs text-gray-500">
          ...
          <div>
            ...
            <div className="leading-relaxed">
              <a href="mailto:support@flyttgo.us" className="hover:text-gray-300">support@flyttgo.us</a><br/>
