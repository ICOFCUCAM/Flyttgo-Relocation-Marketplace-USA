  ...
  },
  {
    ...
    items: [
      { q: 'Are your drivers insured?',
        a: 'Every driver on FlyttGo operates as a registered US business with mandatory goods-in-transit insurance covering up to 500,000 USD per booking. We verify the policy before they can accept jobs.' },
      ...
      { q: 'What if my goods get damaged?',
        a: 'Open a claim from your booking page within 48 hours of delivery. The driver\u2019s insurance covers most damage, and FlyttGo will mediate if the process stalls. See our Safety & Insurance page for details.' },
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'Do I need my own van?',
        a: 'Yes — FlyttGo is a marketplace, not a rental company. You need a registered US business, a van with valid insurance, and a clean driving record to start accepting jobs.' },
...
export default function FaqPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <MarketplaceBanner
        variant="inverse"
        eyebrow={t('faq.heroBadge')}
        breadcrumb={{ id: 'GLRM.FAQ', label: 'FAQ' }}
        headline={t('faq.heroTitle')}
        lead={t('faq.heroSubtitle')}
      />
