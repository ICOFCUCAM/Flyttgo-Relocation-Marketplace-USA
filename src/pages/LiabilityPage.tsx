        ...
        <div className="prose prose-sm max-w-none prose-headings:text-[#0B2E59] prose-headings:font-bold space-y-10">
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              This Liability and Insurance Policy must be read alongside FlyttGo's Terms and Conditions. It sets out, in unambiguous terms, the complete and absolute separation between FlyttGo Inc. as a technology platform operator and the Transport Providers who deliver actual services to Customers.
            </p>
            <div className="grid sm:grid-cols-2 gap-4 mb-5">
              <div className="bg-blue-50 rounded-xl p-5">
                <p className="font-bold text-[#0B2E59] mb-3">FlyttGo Inc. — Platform Operator</p>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#0B2E59] mb-4">2. FlyttGo's Absolute Liability Exclusion</h2>
            <div className="bg-red-50 border-l-4 border-red-600 px-5 py-5 rounded-r-xl mb-5">
              ...
              <p className="text-red-700 text-sm leading-relaxed mb-3">
                FlyttGo Inc., its shareholders, directors, officers, employees, agents, contractors, and technology partners hereby expressly and irrevocably exclude all liability for:
              </p>
            ...
            <p className="text-gray-700 leading-relaxed">
              This exclusion applies regardless of how a claim is framed — whether in contract, tort (including negligence), statute, or otherwise — and regardless of whether FlyttGo was advised of the possibility of such loss or damage. Where liability cannot be excluded under mandatory provisions of US or EU consumer law, FlyttGo's maximum aggregate liability is limited to the platform commission received in respect of the specific transaction giving rise to the claim, or USD 500, whichever is lower.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Every Transport Provider using the FlyttGo Platform is required, as a non-negotiable condition of access, to maintain the following insurance coverage at all times:
            </p>
            ...
            <p className="text-gray-700 leading-relaxed mt-5">
              FlyttGo reserves the right to request proof of insurance at any time. Failure to maintain required insurance is grounds for immediate account suspension. The discovery of a lapsed or invalid insurance policy does not create any liability for FlyttGo.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="bg-orange-50 border-l-4 border-orange-500 px-5 py-4 rounded-r-xl mb-5">
              ...
              <p className="text-orange-700 text-sm">
                Every Transport Provider on the FlyttGo Platform MUST operate under a validly registered US company (Aksjeselskap/AS, Enkeltpersonforetak/ENK, or equivalent legal entity with valid US organization number). Individual persons operating without company registration are categorically prohibited from providing services through the Platform. This requirement is non-negotiable and non-waivable.
              </p>
            </div>
            <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <p className="text-gray-700 leading-relaxed">
              FlyttGo verifies company registration status against Delawareregistrene during onboarding. FlyttGo reserves the right to conduct re-verification at any time. Presentation of false registration information is grounds for permanent ban and may be reported to relevant US authorities.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="space-y-3">
              {[
                ...
                { step: '2', title: 'Report Within 48 Hours', desc: 'Notify FlyttGo via the app or at support@flyttgo.com within 48 hours of delivery. Include booking reference, photographs, and description of damage/loss.' },
                { step: '3', title: 'FlyttGo Provides Transport Provider Details', desc: 'FlyttGo will provide the Customer with the Transport Provider\'s registered company name, address, contact details, and insurer information to facilitate a direct claim.' },
                { step: '4', title: 'File Claim With Transport Provider\'s Insurer', desc: 'The Customer must file a formal claim directly with the Transport Provider\'s insurance company. FlyttGo is not a party to this claim and cannot represent either party.' },
                { step: '5', title: 'Escrow Dispute (Payment Only)', desc: 'Where a dispute relates to escrowed payment, FlyttGo will review evidence from both parties and make a final determination on release. This is limited to the payment dispute only.' },
              ].map(item => (
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              <li>Transport services are provided exclusively by independent third-party companies, not by FlyttGo;</li>
              <li>FlyttGo does not guarantee the quality, safety, or reliability of any Transport Provider;</li>
              ...
              <li>Claims for damage or loss must be made against the Transport Provider's company, not FlyttGo;</li>
              <li>FlyttGo's verification of Transport Providers is a minimum-standard check only and does not constitute a guarantee of service quality or insurance adequacy.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <div className="bg-blue-50 rounded-xl p-5">
              ...
              <p className="text-blue-700 text-sm leading-relaxed">
                FlyttGo strongly advises Customers transporting items with a value exceeding USD 50,000 to: (a) obtain independent all-risk transit insurance before booking; (b) confirm in writing with the Transport Provider that their insurance covers the specific value of items being transported; and (c) consider specialist fine art, antique, or high-value goods movers for particularly valuable or irreplaceable items. FlyttGo accepts no liability for high-value items under any circumstances.
              </p>
            </div>
          </section>
